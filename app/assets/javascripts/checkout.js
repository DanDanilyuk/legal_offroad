          ...
          path = function () {
            switch (false) {
              case viewClass !== FallbackView:
                return "/v3/fallback/4CW9sPSVJphx5OsIVs7jQ.html";
              case !useManhattan:
                return "/m/v3/index-f925604dd4aa6c77a2d874f2507bf975.html";
              default:
                return "/v3/0kKGyE0gdh2c0ou2fBLBBQ.html"
            }
          }();
          ...
          cb = function (_this) {
            return function () {
              ...
              iframeFallback = function () {
                ...
                _this.view = new IframeView(_this.onToken, _this.host, "/v3/0kKGyE0gdh2c0ou2fBLBBQ.html");
